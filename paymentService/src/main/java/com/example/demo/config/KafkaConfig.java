...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, StockReservedEvent> stockReservedConsumerFactory() {
        ...
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.example.demo.event.StockReservedEvent");
    ...
    @Bean
    public ProducerFactory<String, PaymentConfirmedEvent> paymentConfirmedProducerFactory() {
        Map<String, Object> configProps = new HashMap<>();
    ...
    public KafkaTemplate<String, PaymentConfirmedEvent> paymentConfirmedKafkaTemplate() {
        return new KafkaTemplate<>(paymentConfirmedProducerFactory());
    }
